...
#ifdef UNK
/* Try to read machine values from float.h as much as possible */

#ifdef DBL_EPSILON
double MACHEP =  DBL_EPSILON/2.0;
#else
#if 1
...
/* Try to read math values from math.h as much as possible */
#ifdef M_PI
double PI     =  M_PI;
#else
...
#ifdef M_3PI_4
double THPIO4 =  M_3PI_4;
#else
double THPIO4 =  2.35619449019234492885;       /* 3*pi/4 */
#endif

#ifdef M_2_PI
double TWOOPI =  M_2_PI;
#else
double TWOOPI =  6.36619772367581343075535E-1; /* 2/pi */
#endif

/* INFINITY is often defined in math.h; rename to CEPHESINFINITY */
#if defined(INFINITY) || defined(HUGE_VAL)
double CEPHESINFINITY;
/* then we will set CEPHESINFINITY in init_statistics */
#else
#ifdef INFINITIES
double CEPHHESINFINITY = 1.0/0.0;  /* 99e999; */
#else
double CEPHESINFINITY =  1.79769313486231570815E308;    /* 2**1024*(1-MACHEP) */
#endif
#endif
...
#else
#ifdef INFINITIES
unsigned short CEPHESINFINITY[4] = {0x0000,0x0000,0x0000,0x7ff0};
#else
unsigned short CEPHESINFINITY[4] = {0xffff,0xffff,0xffff,0x7fef};
#endif
#endif
#ifndef NAN
#ifdef NANS
...
#else
#ifdef INFINITIES
unsigned short CEPHESINFINITY[4] = {0x7ff0,0x0000,0x0000,0x0000};
#else
unsigned short CEPHESINFINITY[4] = {0x7fef,0xffff,0xffff,0xffff};
#endif
#endif
#ifndef NAN
#ifdef NANS
...
unsigned short CEPHESINFINITY[4] = {077777,0177777,0177777,0177777,};
#endif
#ifndef NAN
...
#if !(defined(INFINITY) || defined(HUGE_VAL))
extern unsigned short CEPHESINFINITY[];
#endif
#ifndef NAN
