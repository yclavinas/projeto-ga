...
#
# Run daily Dispatcher for one day and RELM Mainshock/Aftershock models generation and evaluation
#
...
nohup python $CENTERCODE/src/generic/Dispatcher.py --year="$year" --month="$month" --day="$day" --configFile=$CSEP/cronjobs/dispatcher_daily.init.xml --waitingPeriod=31 --disableMatlabDisplay --enableForecastXMLTemplate --enableForecastMap --publishServer=csep-usc@intensity.usc.edu --publishDirectory=/var/www/html/csep/data/us/usc/california --logFile="$logfile" >& "$logfile" &
