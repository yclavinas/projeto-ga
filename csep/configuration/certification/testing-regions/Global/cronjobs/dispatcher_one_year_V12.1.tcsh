...
nohup python $CENTERCODE/src/generic/Dispatcher.py --year="$year" --month="$month" --day="$day" --configFile=$CSEP/testing-regions/Global/cronjobs/dispatcher_one_year_V12.1.init.xml --disableRawDataDownload --disableRawDataPreProcess --waitingPeriod=31 --publishServer=csep-usc@northridge.usc.edu --publishDirectory=/var/www/html/csep/data/us/usc/global --logFile="$logfile" >& "$logfile" &
