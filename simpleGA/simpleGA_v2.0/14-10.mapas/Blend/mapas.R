...
raw_data = read.csv2("2001-cxBlend(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2001 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2002-cxBlend(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2002 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2003-cxBlend(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2003 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2004-cxBlend(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2004 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2005-cxBlend(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2005 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2006-cxBlend(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2006 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2007-cxBlend(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2007 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2008-cxBlend(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2008 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2009-cxBlend(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2009 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2010-cxBlend(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
