#2000-media melhores
#2001-media pop
setwd("~/Documents/UnB/GA/projeto-ga/simpleGA/simpleGA_v2.0/14-10.mapas/SimulatedBinaryBounded")
options(scipen=999)
library(grid)
...
raw_data = read.csv2("2000-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2000 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2001-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2001 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2002-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2002 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2003-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2003 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2004-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2004 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2005-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2005 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2006-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2006 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2007-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2007 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2008-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2008 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2009-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2009 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2010-cxSimulatedBinaryBounded(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
