#2000-media melhores
#2001-media pop
setwd("~/Documents/UnB/GA/projeto-ga/simpleGA/simpleGA_v2.0/14-10.mapas/SimulatedBinary")
options(scipen=999)
library(grid)
...
raw_data = read.csv2("2000-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2000 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2001-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2001 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2002-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2002 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2003-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2003 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2004-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2004 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2005-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2005 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2006-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2006 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2007-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2007 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2008-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2008 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2009-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
y2009 = apply(teste, 1, as.numeric)
raw_data = read.csv2("2010-cxSimulatedBinary(selRoulette, mutPolynomialBounded).txt", sep='', header=F)
teste = apply(raw_data, 1, as.character)
